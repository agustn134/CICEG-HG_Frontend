...
export class PdfTemplatesService {
  ...
  // ✅ Los datos ya vienen procesados desde PdfGeneratorService
  ...
  // ✅ SOLO devolver la definición (lo que estaba dentro de documentDefinition)
  // return {
                  ...
                  {},
                  {
                    columns: [
                      ...
                      },
                      {
                        width: '33%',
                        text: `TA: ${
                          signosVitales.presion_arterial_sistolica ||
                          '___'
                        }/${
  ...
  async generarNotaUrgencias(datos: any): Promise<any> {
      console.log('🚨 Generando Nota de Urgencias según NOM-004...');
       // Usa los datos ya preparados que vienen del PdfGeneratorService
    // ✅ Usar los datos ya preparados que vienen del PdfGeneratorService
    const medicoCompleto = datos.medicoCompleto;
    const pacienteCompleto = datos.pacienteCompleto;
    const signosVitales = datos.signosVitales;
                    ...
                    table: {
                      ...
                      body: [
                        ...
                        [
                          ...
                          {
                            text: datos.notaUrgencias?.numero_cama || 'Urgencias',
                            fontSize: 7,
                            alignment: 'center',
                            margin: [0, 1],
                          },
            ...
            table: {
              ...
              body: [
                ...
                [
                  ...
                  {
                    text:
                      datos.notaUrgencias?.motivo_atencion ||
...
// 📄 NOTA POSTANESTÉSICA SEGÚN NOM-004-SSA3-2012 SECCIÓN D11
  ...
  console.log('📄 PdfTemplatesService: Creando definición Consentimiento Procedimientos...');
            ...
            [
              {
                text: [
                  ...
                  { text: datos.consentimiento?.nombre_procedimiento || '[PROCEDIMIENTO A REALIZAR]', fontSize: 9 },
                  { text: '\n\nDescripción del procedimiento:\n', bold: true, fontSize: 9 },
                  { text: datos.consentimiento?.descripcion_procedimiento || 'El médico explicará en detalle el procedimiento a realizar, sus objetivos y metodología.', fontSize: 8 },
                ],
                margin: [10, 8],
              },
            ],
      ...
      // Beneficios y riesgos
      {
        table: {
          ...
          body: [
            ...
            [
              {
                text: datos.consentimiento?.beneficios_procedimiento || 
              ...
              {
                text: datos.consentimiento?.riesgos_especificos || 
            ...
            [
              {
                text: [
                  ...
                  { text: `${pacienteCompleto.nombre_completo}`, fontSize: 9, bold: true, decoration: 'underline' },
                  ...
                  { text: `${medicoCompleto.nombre_completo}`, fontSize: 8, bold: true },
                  { text: ' y su equipo médico a realizar el procedimiento descrito.\n\n', fontSize: 8 },
                  
                  { text: '5. ', fontSize: 9, bold: true },
                  { text: 'Este consentimiento es otorgado de manera libre, voluntaria e informada.', fontSize: 8 },
                ],
                margin: [10, 8],
                lineHeight: 1.4,
              },
            ...
            [
              ...
              },
              {
                text: [
                  ...
                  { text: `Cédula: ${medicoCompleto.numero_cedula}`, fontSize: 6 },
                ],
                alignment: 'center',
                margin: [5, 15],
              },

...
// /**
//  * 🆕 Verificar qué endpoints de catálogo están disponibles
//  */
...
// //       console.log(`🔄 Usando ${staticData.length} items estáticos para ${tipo}`);
...
// // MÉTODO fetchCatalogo SIN ENVIRONMENT
...
// // 🎯 OPCIONAL: Método para verificar endpoints silenciosamente
// async checkAvailableEndpoints(): Promise<{ [key: string]: boolean }> {
//   const endpointsToCheck = [
//     'tipos-sangre',
//     'estados-civiles',

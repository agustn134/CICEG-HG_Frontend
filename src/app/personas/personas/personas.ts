...
export class PersonasComponent implements OnInit, OnDestroy {
  ...
  createPersona(): void {
    if (this.personaForm.valid) {
      const personaData: CreatePersonaDto = this.personaForm.value;
  ...
  updatePersona(): void {
    if (this.personaForm.valid && this.selectedPersona()) {
      const personaData: UpdatePersonaDto = {
        id_persona: this.selectedPersona()!.id_persona,
        ...this.personaForm.value
      };

      this.personasService.updatePersona(personaData.id_persona, personaData).subscribe({
        next: (response) => {
          if (response.success) {
            this.closeModal();
            this.loadPersonas();
  ...
  openDeleteModal(persona: Persona): void {
    this.selectedPersona.set(persona);
  ...
  viewPersona(persona: Persona): void {

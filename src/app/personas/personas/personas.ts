...
// import {
//   PersonaFrontend, // 🔥 CAMBIO: usar PersonaFrontend
//   CreatePersonaFrontendDto, // 🔥 CAMBIO: usar CreatePersonaFrontendDto
//   PersonaFilters,
//   Genero,
//   EstadoCivil,
//   PaginationInfo
...
//   personas = signal<PersonaFrontend[]>([]); // 🔥 CAMBIO
...
// // Math: any;
// // En personas.ts, agregar esta línea en la clase:
// Math = Math;
//   constructor(
...
//       const personaData: CreatePersonaFrontendDto = this.personaForm.value; // 🔥 CAMBIO
...
//       this.personasService.deletePersona(this.selectedPersona()!.id_persona!).subscribe({ // 🔥 CAMBIO: agregar !
//         next: (response) => {
//           if (response.success) {
...
//    togglePersona(persona: PersonaFrontend): void { // 🔥 CAMBIO: usar PersonaFrontend
//     this.personasService.togglePersona(persona.id_persona!).subscribe({
//       next: (response) => {
//         if (response.success) {
//           this.loadPersonas();
//         }
...
//     this.activeFilter.set(formValue.activo === '' ? undefined : formValue.activo === 'true');
...
//   // ==========================================
//   formatearNombreCompleto(persona: PersonaFrontend): string { // 🔥 CAMBIO
...
//   getInitials(persona: PersonaFrontend): string { // 🔥 CAMBIO
...
//   trackByPersonaId(index: number, persona: PersonaFrontend): number { // 🔥 CAMBIO
//     return persona.id_persona!;
//   }

//   viewPersona(persona: PersonaFrontend): void { // 🔥 CAMBIO

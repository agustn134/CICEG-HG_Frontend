...
export class PasoPaciente implements OnInit, OnDestroy {
  ...
  private validatePreviousStep(): void {
    ...
    console.log('🔍 Validando paso anterior. Estado actual del wizard:', currentState);
    ...
    console.log('✅ Validación del paso anterior exitosa. ID Persona:', currentState.id_persona_creada);
  }
